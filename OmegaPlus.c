...
int main(int argc, char** argv)
{
	...
	FILE *fpIn=NULL, *fpInfo=NULL, *fpWarnings=NULL, *fpReport=NULL, *fpVCFsamples=NULL, *gridFile=NULL;
	...
	omega_struct * omega;
   	...
   	commandLineParser(argc, argv, inputFileName, &grid, &alignmentLength, &minw, &maxw, recfile, 
			  ...
			  &generateVCFsamplelist, &memLimit, gridFileName);
...
*/
		    ...
		    if(gridFile == NULL)
		      ...
		      matrixSizeMax = findOmegaBoundsGridFile(gridFile, alignment, &omega, &grid, &maxw, minw, minsnps);
